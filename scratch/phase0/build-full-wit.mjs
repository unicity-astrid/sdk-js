...
const { component, imports } = await componentize({
  sourcePath: new URL("./full-wit-stub.js", import.meta.url).pathname,
  witPath: new URL("./wit-real", import.meta.url).pathname,
  worldName: "capsule",
...
await writeFile("dist/full-wit-stub.wasm", component);
const info = await stat("dist/full-wit-stub.wasm");
