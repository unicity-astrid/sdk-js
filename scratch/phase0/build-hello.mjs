...
const { component, imports } = await componentize({
  sourcePath: new URL("./hello.js", import.meta.url).pathname,
  witPath: new URL("./hello.wit", import.meta.url).pathname,
  worldName: "hello",
...
await writeFile("dist/hello.wasm", component);
const info = await stat("dist/hello.wasm");
